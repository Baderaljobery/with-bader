...
const PLATFORMS: ContentPlatform[] = ["linkedin", "x", "instagram", "general"];
...
export function PlatformSelect({ value, onChange, disabled }: PlatformSelectProps) {
  return (
    <div className="grid grid-cols-2 gap-2.5 sm:grid-cols-4" role="radiogroup" aria-label="أين تريد نشر المحتوى؟">
