...
/** For image-generation calls (create -> generate, regenerate-all,
 * regenerate one slide). */
export function mapDesignGenerationError(error: unknown): string {
  if (error instanceof ApiError) {
    switch (error.status) {
      case 504:
        return "استغرق إنشاء التصميم وقتًا أطول من المتوقع. حاول مرة أخرى.";
      case 502:
        return "تعذر الاتصال بخدمة إنشاء التصميم. حاول مرة أخرى.";
      case 500:
        return "تعذر إعداد خدمة إنشاء التصميم.";
      default:
        return "تعذر إنشاء التصميم، حاول مرة أخرى.";
    }
  }
  return "تعذر إنشاء التصميم، حاول مرة أخرى.";
}
