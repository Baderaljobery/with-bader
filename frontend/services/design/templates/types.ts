...
export type SlideRenderProps = {
  ...
  className?: string;
  /** Reports whether the rendered text genuinely overflows its safe
   * content area (real scrollHeight/clientHeight measurement via
   * useBalancedAlignment, not a character count) - optional because a
   * thumbnail/export render never needs to know. */
