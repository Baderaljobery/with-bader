  ...
  return (
    <TemplateFrame ref={ref} aspectRatio={aspectRatio} background={C.background} className={className}>
      ...
      <div className="relative flex h-full flex-col p-[8cqw]">
        {role === "quote" ? (
          <div ref={zoneRef} className={cn("flex min-h-0 flex-1 items-center", zoneJustifyClassName)}>
            <div
              ref={contentRef}
              className="max-w-[85%] rounded-[2cqw] px-[6cqw] py-[5cqw] text-center"
              style={{ backgroundColor: C.mark, ...contentStyle }}
            >
          ...
          <div ref={zoneRef} className={cn("flex min-h-0 flex-1 flex-col", zoneJustifyClassName)}>
            <div ref={contentRef} style={contentStyle}>
              <p className="font-thmanyah-sans text-[6cqw] font-black leading-[1.05]" style={{ color: C.mark }}>
                {headline}
              </p>
              <div className="mt-[4cqw] flex flex-wrap gap-[2cqw]">
          ...
          <div ref={zoneRef} className={cn("flex min-h-0 flex-1 flex-col items-start", zoneJustifyClassName)}>
            <div ref={contentRef} className="flex flex-col items-start gap-[2.5cqw]" style={contentStyle}>
