  ...
  return (
    <TemplateFrame ref={ref} aspectRatio={aspectRatio} background={C.background} className={className}>
      <div className="flex h-full flex-col p-[7cqw]">
        {role === "quote" ? (
          <div ref={zoneRef} className={cn("flex min-h-0 flex-1 flex-col items-center text-center", zoneJustifyClassName)}>
          ...
          <div ref={zoneRef} className={cn("flex min-h-0 flex-1 flex-col", zoneJustifyClassName)}>
            <div ref={contentRef} style={contentStyle}>
              ...
              <ul className="mt-[4cqw] space-y-[3cqw]">
          ...
          <>
            ...
            {role === "cover" || role === "main_content" ? (
              <div className="-mx-[7cqw] flex shrink-0 flex-col gap-[2cqw] px-[7cqw] pt-[3cqw]">
                <DotRow />
