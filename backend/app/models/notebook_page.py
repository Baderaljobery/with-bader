...
class NotebookPage(Base):
    ...
    __table_args__ = (
        CheckConstraint("position >= 0", name="notebook_pages_position_check"),
        Index("idx_notebook_pages_notebook", "notebook_id"),
        Index("idx_notebook_pages_position", "notebook_id", "position"),
    )
    ...
    title: Mapped[str] = mapped_column(Text, nullable=False, server_default="Untitled Page")
